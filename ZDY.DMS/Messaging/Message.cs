...
namespace ZDY.DMS.Messaging
{
    ...
    {
        public const string MessageClrTypeNameMetadataKey = "$message.clrtype";
        ...
        /// <summary>
        /// Gets an instance of <see cref="T:ZDY.DMS.Messaging.MessageMetadata" /> class which contains the
