namespace ZDY.DMS.Querying.SearchModel.Model
{
    ...
    public class ConditionItem
    {
        ...
        public ConditionItem(string field, QueryMethod method, object value)
        {
            Field = field;
            Method = method;
            Value = value;
        ...
        public ConditionItem(string field, QueryMethod method, object value, string prefix, string orGroup)
        {
            Field = field;
            Method = method;
            Value = value;
